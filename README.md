...
<div align="center">
<p>
  <img alt="Workshopy: 4" src="https://img.shields.io/badge/workshopy-4-6f42c1">
...
| ----- | --------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------- | --------------------------- |
| `0`   | 0/9 — instalacja      | [Instalacja Pythona](./0%20Instalacja%20Pythona/)                         | Przygotowane środowisko Python, Jupyter i `.venv`             | Python, Jupyter, venv       |
| `101` | 1/9 — wprowadzenie    | [Wprowadzenie do uczenia maszynowego](./101-wprowadzenie-do-uczenia-maszynowego/) | Pierwsze modele klasyfikacji i regresji w notebookach         | Python, scikit-learn        |
| `102` | 1/9 — wprowadzenie    | [Lokalne LLM z Ollamą](./102-wprowadzenie-do-ollamy/)                     | Lokalny model, skuteczne prompty i pierwsza integracja Python | Ollama, Python, Jupyter     |
| `301` | 3/9 — podstawowy plus | [Podstawy TTS](./301-podstawy-tts/README.pl.md)                           | Lokalna aplikacja zamieniająca tekst na mowę                  | Supertonic 3, FastAPI, ONNX |
...
```powershell
Set-Location 101-wprowadzenie-do-uczenia-maszynowego
```

albo:

```powershell
Set-Location 102-wprowadzenie-do-ollamy
```

albo:

```powershell
Set-Location 301-podstawy-tts
```
...
├── 0 Instalacja Pythona/            # przygotowanie środowiska
├── 101-wprowadzenie-do-uczenia-maszynowego/ # podstawy uczenia maszynowego
├── 102-wprowadzenie-do-ollamy/      # lokalne modele językowe
├── 301-podstawy-tts/                # lokalna synteza mowy
...
- [Jakub Mielcarek](https://github.com/vGiacomov),
- Jakub Szczerbiński,
- Marta Machacka,
- [Kacper Boś](https://github.com/bos-8),
